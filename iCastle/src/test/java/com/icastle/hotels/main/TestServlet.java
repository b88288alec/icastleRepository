...
//		dao.addHotel(hotel);
		...
		// int peopleNum = 4;
		// List<ListVO> hotels = dao.indexQuery(zone, startDate, endDate,
		// peopleNum);
		...
		// double point = 0;
		// int star = 5;
		// List<ListVO> hotels = dao.advancedQuery(zone, startDate, endDate,
		// peopleNum, order, lowprice, highprice, point, star);
		// for (ListVO list : hotels)
		// System.out.println(list.getHotelName());
	}
