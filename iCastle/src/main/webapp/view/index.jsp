...
<body>
    ...
    <div clsaa="container-fluid" style="position:relative;">
            ...
            <img src="../img/overlay.png" class="logoheader img-responsive"/>
            ...
            <form action="Query.do" method="get">
                <div class="col-md-2 col-xs-12 col-sm-4" style="margin:15px;">
                    <div class="input-group input-group-sm">
                        <p>查詢型態</p>
                        <input type="text" class="form-control" placeholder="輸入區域或飯店名稱" name="type"/>
                    </div>
                </div>
                ...
                <div class="col-md-2 col-xs-12 col-sm-4" style="margin:15px;">
                    <div class="input-group input-group-sm">
                        <p>入住人數</p>
                        <input type="text" class="form-control" placeholder="輸入入住人數" name="peopleNum"/>
                    </div>
                </div>
                <div class="clearfix visible-xs-block"></div>
                <div class="col-md-2 col-xs-12 col-sm-4" style="margin:15px;">
        ...
        <div class="row">
            <div class="col-md-3 col-xs-12 col-sm-4" style="margin-right:60px;">
                <div class="card" style="width:300px;">
                    <img src="../img/60395_16042612080041805392.jpg" style="width:100%;" />
            ...
            <div class="col-md-3 col-xs-12 col-sm-4" style="margin-right:60px;">
                <div class="card" style="width:300px;">
                    <img src="../img/3843_15070211000031541467.jpg" style="width:100%;"/>
                    <div class="cardContext">
                        <h4>漢來大飯店</h4>
                        <p>高雄前金區</p>
                    </div>
            ...
            <div class="col-md-3 col-xs-12 col-sm-4" style="margin-right:60px;">
                <div class="card" style="width:300px;">
                    <img src="../img/201242_16042216170041722027.jpg" style="width:100%;"/>
                    <div class="cardContext">
                        <h4>蘭城晶英酒店</h4>
                        <p>宜蘭市</p>
                    </div>
            ...
            <div class="col-md-3 col-xs-12 col-sm-4" style="margin-right:60px;">
                <div class="card" style="width:300px;">
                    <img src="../img/104996_110408145504225.jpg" style="width:100%;"/>
                    <div class="cardContext">
                        <h4>礁溪老爺酒店</h4>
                        <p>宜蘭縣礁溪鄉</p>
                    </div>
