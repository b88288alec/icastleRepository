...
window.onload = function(){
	...
	document.getElementById("star6").onclick = function(){
		...
		document.getElementById("star6").src="star.png";
		document.getElementById("star7").src="unstar.png";
		document.getElementById("star8").src="unstar.png";
		document.getElementById("star9").src="unstar.png";
		document.getElementById("star10").src="unstar.png";
		console.log("6&1");
	}
	...
	document.getElementById("star7").onclick = function(){
		...
		document.getElementById("star6").src="star.png";
		document.getElementById("star7").src="star.png";
		document.getElementById("star8").src="unstar.png";
		document.getElementById("star9").src="unstar.png";
		document.getElementById("star10").src="unstar.png";
		console.log("7&2");
	...
	document.getElementById("star8").onclick = function(){
		...
		document.getElementById("star6").src="star.png";
		document.getElementById("star7").src="star.png";
		document.getElementById("star8").src="star.png";
		document.getElementById("star9").src="unstar.png";
		document.getElementById("star10").src="unstar.png";
		console.log("8&3");
	}
	...
	document.getElementById("star9").onclick = function(){
		...
		document.getElementById("star7").src="star.png";
		document.getElementById("star8").src="star.png";
		document.getElementById("star9").src="star.png";
		document.getElementById("star10").src="unstar.png";
		console.log("9&4");
	}
	...
	document.getElementById("star10").onclick = function(){
		...
		document.getElementById("star8").src="star.png";
		document.getElementById("star9").src="star.png";
		document.getElementById("star10").src="star.png";
		console.log("10&5");
	}
	...
	document.getElementById("star11").onclick = function(){
		...
		document.getElementById("star12").src="unstar.png";
		document.getElementById("star13").src="unstar.png";
		document.getElementById("star14").src="unstar.png";
		document.getElementById("star15").src="unstar.png";
		console.log("11&1");
	}
	...
	document.getElementById("star14").onclick = function(){
		...
		document.getElementById("star12").src="star.png";
		document.getElementById("star13").src="star.png";
		document.getElementById("star14").src="star.png";
		document.getElementById("star15").src="unstar.png";
		console.log("14&4");
	}
	...
	document.getElementById("star15").onclick = function(){
		...
		document.getElementById("star13").src="star.png";
		document.getElementById("star14").src="star.png";
		document.getElementById("star15").src="star.png";
		console.log("15&5");
...
<img src="unstar.png" width="50" id="star7">
...
<img src="unstar.png" width="50" id="star12">
